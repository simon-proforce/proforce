...
// ─── DATA ─────────────────────────────────────────────────────────────────────
const TEAM = [
  { name:"Simon St-Amand",   init:"SS", title:{en:"President",fr:"Président"}, sector:{en:"Food / CPG & Fashion",fr:"Alimentaire / CPG & Mode"}, linkedin:"https://www.linkedin.com/in/simonstamand", articles:["recrutement-passif","agisme-recrutement","erreurs-offre-emploi","marche-alimentaire-2026","combien-coute-recruteur","processus-entrevue-trop-long","salaires-alimentaire-canada-2026","penurie-main-oeuvre-alimentaire","onboarding-nouveau-directeur"],
    bio:{en:"Simon founded Proforce in 2001 and has been building it ever since. He knows the food, CPG, and fashion markets in Montreal and Toronto as well as anyone in recruitment. His approach is direct, relationship-driven, and built on accountability. When you work with Proforce, you work with someone who's been doing this long enough to know what actually matters.",
         fr:"Simon a fondé Proforce en 2001 et bâtit la firme depuis. Il connaît les marchés alimentaire, CPG et mode à Montréal et Toronto aussi bien que n'importe qui dans le recrutement. Son approche est directe, axée sur les relations et fondée sur l'imputabilité. Quand tu travailles avec Proforce, tu travailles avec quelqu'un qui fait ça depuis assez longtemps pour savoir ce qui compte vraiment."} },
  { name:"Robin Anisef",     init:"RA", title:{en:"Partner",fr:"Associée"}, sector:{en:"Fashion & Apparel",fr:"Mode & Habillement"}, linkedin:"https://www.linkedin.com/in/robinanisef", articles:["mode-recrutement-canada"],
  ...
  { name:"Stéphanie Lanoie", init:"SL", title:{en:"Recruiter",fr:"Recruteuse"}, sector:{en:"Food Industry — Quebec",fr:"Alimentaire — Québec"}, linkedin:"https://www.linkedin.com/in/stephanie-lanoie-84a321a4", articles:["erreurs-offre-emploi","changer-recruteur"],
  ...
  { name:"Michaela Landers", init:"ML", title:{en:"Recruiting Director",fr:"Directrice, recrutement"}, sector:{en:"Food Industry — Ontario",fr:"Alimentaire — Ontario"}, linkedin:"https://www.linkedin.com/in/michaelalanders", articles:["agisme-recrutement","marche-alimentaire-2026","processus-entrevue-trop-long","onboarding-nouveau-directeur"],
...
const POSTS = [
  ...
  { id:"salaires-alimentaire-canada-2026", cat:{en:"Market",fr:"Marché"}, date:"Mars 2026", read:{en:"5 min",fr:"5 min"},
    ...
    body:{en:`The benchmarks have shifted significantly since 2019. Here's what we're actually seeing on offers — not survey data, not industry reports, but real numbers from real mandates in Quebec and Ontario.\n\nPlant Manager (food manufacturing, 200–500 employees): $130,000–$165,000 base. P&L responsibility and union experience push toward the top of that range. In 2019 this role was $95,000–$120,000.\n\nQuality Assurance Director (SQF/HACCP certified, 10+ years): $110,000–$145,000. GFSI audit experience and bilingualism add value in Quebec. Strong demand, limited supply — candidates in this profile are receiving competing offers.\n\nSupply Chain Director (CPG, cross-functional): $115,000–$150,000. SAP and ERP implementation experience push higher. This role has seen the most salary inflation over the past three years.\n\nProduction Supervisor (shift management, 3–5 years experience): $65,000–$85,000. Variable by region — Ontario generally pays 8–12% higher than Quebec for equivalent roles.\n\nFood Safety Manager (HACCP, plant-level): $80,000–$105,000. Bilingual candidates in Quebec are at a premium.\n\nVP Operations (multi-site, full P&L): $170,000–$220,000 base, plus bonus structure. These mandates are retained searches.\n\nA few observations from the field:\n\nCandidates who receive a competing offer during your process will use it to negotiate. Budget accordingly or move faster.\n\nBonus structures matter more than they used to. A candidate choosing between two similar base salaries will lean toward the one with a clear, achievable bonus plan.\n\nRemote work expectations have reset. Most food manufacturing roles require site presence by definition. Candidates know this. The conversation has shifted to flexibility around start times, schedule arrangements, and hybrid options for administrative functions.\n\nIf your compensation ranges haven't been updated since 2022, they're out of market. We see this regularly and it is the single most common reason a search stalls.`,
          fr:`Les références ont bougé significativement depuis 2019. Voilà ce qu'on voit vraiment sur les offres — pas des données de sondage, pas des rapports d'industrie, mais de vrais chiffres de vrais mandats au Québec et en Ontario.\n\nDirecteur d'usine (fabrication alimentaire, 200–500 employés) : 130 000$ à 165 000$ base. La responsabilité P&L et l'expérience en milieu syndiqué poussent vers le haut de cette fourchette. En 2019 ce rôle était à 95 000$–120 000$.\n\nDirecteur assurance qualité (certifié SQF/HACCP, 10+ ans) : 110 000$–145 000$. L'expérience d'audit GFSI et le bilinguisme ajoutent de la valeur au Québec. Forte demande, offre limitée — les candidats dans ce profil reçoivent des offres concurrentes.\n\nDirecteur chaîne d'approvisionnement (CPG, transversal) : 115 000$–150 000$. L'expérience d'implantation SAP et ERP pousse plus haut. Ce rôle a connu la plus forte inflation salariale au cours des trois dernières années.\n\nSuperviseur de production (gestion de quarts, 3–5 ans d'expérience) : 65 000$–85 000$. Variable selon la région — l'Ontario paie généralement 8–12% de plus que le Québec pour des rôles équivalents.\n\nResponsable salubrité alimentaire (HACCP, niveau usine) : 80 000$–105 000$. Les candidats bilingues au Québec sont à prime.\n\nVP Opérations (multi-sites, P&L complet) : 170 000$–220 000$ base, plus structure de boni. Ces mandats sont des recherches retenues.\n\nQuelques observations du terrain :\n\nLes candidats qui reçoivent une offre concurrente pendant ton processus l'utiliseront pour négocier. Budget en conséquence ou bouge plus vite.\n\nSi tes fourchettes de rémunération n'ont pas été mises à jour depuis 2022, elles sont hors marché. On voit ça régulièrement et c'est la raison la plus courante pour laquelle une recherche stagne.`} },
...
function HomePage({ lang, setPage }) {
  const t = {
    en:{
      ...
      sub:"Proforce Personnel places food, CPG, and fashion professionals across Montreal and Toronto. No generalists. No job boards. A network built over 25 years.",
    ...
    fr:{
      ...
      sub:"Proforce Personnel place des professionnels de l'alimentaire, du CPG et de la mode à Montréal et Toronto. Pas de généralistes. Pas de babillards. Un réseau bâti sur 25 ans.",
          ...
          <div style={{ display:"flex", gap:"0", flexWrap:"wrap" }}>
            {TEAM.map((m,i) => (
              <div key={m.name} style={{
                ...
                <div style={{ width:"36px", height:"36px", background:C.orange, display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Clash Display',sans-serif", fontSize:"0.8rem", color:"#fff", fontWeight:700, marginBottom:"1rem" }}>{m.init}</div>
    ...
    <div>
      <section style={{ background:C.ink, minHeight:"65vh", display:"flex", flexDirection:"column", justifyContent:"flex-end", padding:"8rem 2rem 4rem" }}>
        <div style={{ maxWidth:"900px" }}>
          ...
          <h1 className="fu" style={{ fontFamily:"'Clash Display',sans-serif", fontWeight:700, fontSize:"clamp(3rem,8vw,7rem)", letterSpacing:"-0.03em", color:C.ink, lineHeight:0.92, marginBottom:"0.75rem" }}>{t.h1}</h1>
...
const FEATURED = [
  {
    ...
    highlights: {
      en:["SQF Practitioner, HACCP & FSMA certified","Led QA programs across 3 manufacturing facilities","Managed teams of 12–18 QA professionals","Fluent in English and French"],
  ...
  },
  {
    ...
    highlights: {
      en:["Managed facilities of 200–400 employees","P&L responsibility up to $85M","HACCP, SQF Level 3, and FSEP certified","Strong track record in union environments"],
  ...
  },
  {
    ...
    avail: { en:"Open to opportunities", fr:"Ouvert aux opportunités" },
    highlights: {
      en:["Managed open-to-buy budgets of $8–15M","Strong vendor relationships across Europe and Asia","Experience with both mass market and contemporary brands","Bilingual, French-first market expertise"],
...
function AboutPage({ lang }) {
  const t = {
    en:{ eyebrow:"About Proforce Personnel — Montreal & Toronto", h1:"A specialist firm.", h1i:"Built on purpose.", story:"Simon St-Amand founded Proforce Personnel in 2001 with a clear idea: build a recruitment firm that actually knows the industries it serves. Not a generalist agency that does everything for everyone. A specialist firm focused on food, CPG, and fashion — placing professionals in Montreal, Toronto, and Atlantic Canada. 25 years later, that's still the idea.",
    ...
    fr:{ eyebrow:"À propos de Proforce Personnel — Montréal & Toronto", h1:"Une firme spécialisée.", h1i:"Construite intentionnellement.", story:"Simon St-Amand a fondé Proforce Personnel en 2001 avec une idée claire : bâtir une firme de recrutement qui connaît vraiment les industries qu'elle sert. Pas une agence généraliste. Une firme spécialisée en alimentaire, CPG et mode — qui place des professionnels à Montréal, Toronto et dans les provinces atlantiques. 25 ans plus tard, c'est encore ça l'idée.",
    ...
    <div>
      <section style={{ background:C.ink, minHeight:"50vh", display:"flex", flexDirection:"column", justifyContent:"flex-end", padding:"8rem 2rem 4rem" }}>
        <div style={{ maxWidth:"900px" }}>
          ...
          <h1 className="fu" style={{ fontFamily:"'Clash Display',sans-serif", fontWeight:700, fontSize:"clamp(3rem,8vw,6.5rem)", letterSpacing:"-0.03em", color:C.ink, lineHeight:0.92, marginBottom:"1.5rem" }}>
              ...
              >
                ...
                <div>
                  <div style={{ display:"flex", alignItems:"center", gap:"1rem", marginBottom:"1.5rem" }}>
                    <div style={{ width:"48px", height:"48px", background:C.orange, display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Clash Display',sans-serif", fontSize:"0.9rem", color:"#fff", fontWeight:700, flexShrink:0 }}>{m.init}</div>
                    <div>
                      <div style={{ fontFamily:"'Clash Display',sans-serif", fontSize:"1rem", color:C.ink, fontWeight:600 }}>{m.name}</div>
                      <div style={{ fontFamily:"'DM Mono',monospace", fontSize:"0.62rem", letterSpacing:"0.08em", textTransform:"uppercase", color:C.orange, marginTop:"2px" }}>{m.title[lang]}</div>
                    </div>
                  </div>
  ...
  return (
    <div>
      <section style={{ background:C.ink, minHeight:"60vh", display:"flex", flexDirection:"column", justifyContent:"flex-end", padding:"8rem 2rem 4rem" }}>
        <div style={{ maxWidth:"900px" }}>
          <Eyebrow>{t.eyebrow}</Eyebrow>
          <h1 className="fu" style={{ fontFamily:"'Clash Display',sans-serif", fontWeight:700, fontSize:"clamp(2.5rem,7vw,6.5rem)", letterSpacing:"-0.03em", color:C.ink, lineHeight:0.92, marginBottom:"0.5rem" }}>{t.h1}</h1>
  ...
  return (
    <div>
      <section style={{ background:C.ink, minHeight:"50vh", display:"flex", flexDirection:"column", justifyContent:"flex-end", padding:"8rem 2rem 4rem" }}>
        <div style={{ maxWidth:"900px" }}>
          <Eyebrow>{t.eyebrow}</Eyebrow>
          <h1 className="fu" style={{ fontFamily:"'Clash Display',sans-serif", fontWeight:700, fontSize:"clamp(3rem,8vw,7rem)", letterSpacing:"-0.03em", color:C.ink, lineHeight:0.92 }}>{t.h1}</h1>
    ...
    <div>
      <section style={{ background:C.ink, minHeight:"50vh", display:"flex", flexDirection:"column", justifyContent:"flex-end", padding:"8rem 2rem 4rem" }}>
        <div style={{ maxWidth:"900px" }}>
          ...
          <h1 className="fu" style={{ fontFamily:"'Clash Display',sans-serif", fontWeight:700, fontSize:"clamp(3rem,8vw,7rem)", letterSpacing:"-0.03em", color:C.ink, lineHeight:0.92, marginBottom:"1rem" }}>
  ...
  return (
    <div>
      <section style={{ background:C.ink, minHeight:"50vh", display:"flex", flexDirection:"column", justifyContent:"flex-end", padding:"8rem 2rem 4rem" }}>
        <div style={{ maxWidth:"900px" }}>
          <Eyebrow>{t.eyebrow}</Eyebrow>
          <h1 className="fu" style={{ fontFamily:"'Clash Display',sans-serif", fontWeight:700, fontSize:"clamp(3.5rem,10vw,9rem)", letterSpacing:"-0.03em", color:C.ink, lineHeight:0.9 }}>{t.h1}</h1>
        </div>
      </section>
      ...
      <section style={{ background:C.white, padding:"6rem 2rem" }}>
        <div className="two-col" style={{ maxWidth:"1000px", margin:"0 auto", display:"grid", gridTemplateColumns:"1fr 1.5fr", gap:"6rem", alignItems:"start" }}>
          {/* Info */}
          <div>
            {[{city:"Montréal",phone:"(514) 905-0606",addr:"500 Place d'Armes, #1800\nMontréal, QC H2Y 2W2"},{city:"Toronto",phone:"(647) 367-1526",addr:"130 King Street West, Suite 1800\nToronto, ON M5X 1E3"}].map(o => (
    ...
    en: {
      ...
      phases: [
        ...
        },
        {
          ...
          duration: "1–3 weeks depending on your process",
      ...
      timelines: [
        { role: lang === "en" ? "Production Supervisor / QA Coordinator" : "Superviseur de production / Coordinateur QA", time: "2–4 weeks" },
        { role: lang === "en" ? "Plant Manager / QA Director" : "Directeur d'usine / Directeur qualité", time: "4–8 weeks" },
        { role: lang === "en" ? "VP Operations / C-Suite" : "VP Opérations / C-niveau", time: "8–14 weeks" },
        { role: lang === "en" ? "Fashion Buyer / Brand Manager" : "Acheteur mode / Gestionnaire de marque", time: "3–6 weeks" },
    ...
    fr: {
      ...
      phases: [
        ...
        },
        {
          ...
          duration: "1–3 semaines selon ton processus",
      ...
      timelines: [
        { role: "Superviseur de production / Coordinateur QA", time: "2–4 semaines" },
        { role: "Directeur d'usine / Directeur qualité", time: "4–8 semaines" },
        { role: "VP Opérations / C-niveau", time: "8–14 semaines" },
        { role: "Acheteur mode / Gestionnaire de marque", time: "3–6 semaines" },
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:"3rem", marginBottom:"3rem" }}>
          <div>
            ...
            <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.82rem", color:"rgba(244,241,235,0.4)", lineHeight:1.7, maxWidth:"220px" }}>
              {lang==="en"?"Specialist recruitment. Food, CPG & Fashion. Montreal & Toronto. Since 2001.":"Recrutement spécialisé. Alimentaire, CPG & Mode. Montréal & Toronto. Depuis 2001."}
            </p>
          </div>
          ...
          <div style={{ display:"flex", gap:"4rem", flexWrap:"wrap" }}>
            ...
            <div>
              ...
              <div style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.82rem", color:"rgba(244,241,235,0.45)", lineHeight:2 }}>
                (514) 905-0606<br/>(647) 367-1526<br/>info@proforce.ca
              </div>
...
const META = {
  home: {
    en: { title:"Proforce Personnel — Specialist Recruitment in Food, CPG & Fashion", desc:"Proforce Personnel places food, CPG, and fashion professionals across Montreal and Toronto. Specialist recruiters, network-first approach, placement guarantee. Since 2001." },
    fr: { title:"Proforce Personnel — Recrutement spécialisé en alimentaire, CPG et mode", desc:"Proforce Personnel place des professionnels de l'alimentaire, du CPG et de la mode à Montréal et Toronto. Recruteurs spécialisés, réseau d'abord, garantie de placement. Depuis 2001." },
  },
  food: {
  ...
  about: {
    en: { title:"About Proforce Personnel — Food, CPG & Fashion Recruitment Since 2001", desc:"Simon St-Amand founded Proforce Personnel in 2001. Specialist recruitment in food, CPG, and fashion across Montreal, Toronto, and Atlantic Canada." },
    fr: { title:"À propos de Proforce Personnel — Recrutement alimentaire, CPG et mode depuis 2001", desc:"Simon St-Amand a fondé Proforce Personnel en 2001. Recrutement spécialisé en alimentaire, CPG et mode à Montréal, Toronto et dans les provinces atlantiques." },
  },
  team: {
    en: { title:"Our Team — Proforce Personnel Montreal & Toronto", desc:"Meet the Proforce team: Simon St-Amand, Robin Anisef, Stéphanie Lanoie, Rana Yamak, and Michaela Landers. Five specialist recruiters in food, CPG, and fashion." },
    fr: { title:"Notre équipe — Proforce Personnel Montréal & Toronto", desc:"Rencontrez l'équipe Proforce : Simon St-Amand, Robin Anisef, Stéphanie Lanoie, Rana Yamak et Michaela Landers. Cinq recruteurs spécialisés en alimentaire, CPG et mode." },
  },
  candidates: {
  ...
  jobs: {
    en: { title:"Job Listings — Proforce Personnel", desc:"Current job openings in food manufacturing, CPG, and fashion across Montreal and Toronto. Permanent placements placed by specialist recruiters." },
    fr: { title:"Offres d'emploi — Proforce Personnel", desc:"Postes ouverts actuellement en fabrication alimentaire, CPG et mode à Montréal et Toronto. Placements permanents par des recruteurs spécialisés." },
  },
  giving: {
  ...
  employers: {
    en: { title:"For Employers — Proforce Personnel", desc:"Proforce Personnel helps food, CPG, and fashion companies find the candidates who weren't looking. Specialist recruiters, placement guarantee, Montreal and Toronto." },
    fr: { title:"Pour les employeurs — Proforce Personnel", desc:"Proforce Personnel aide les compagnies alimentaires, CPG et mode à trouver les candidats qui ne cherchaient pas. Recruteurs spécialisés, garantie de placement, Montréal et Toronto." },
  },
  contact: {
    en: { title:"Contact — Proforce Personnel", desc:"Get in touch with Proforce Personnel. Montreal: (514) 905-0606. Toronto: (647) 367-1526. info@proforce.ca" },
    fr: { title:"Contact — Proforce Personnel", desc:"Contactez Proforce Personnel. Montréal : (514) 905-0606. Toronto : (647) 367-1526. info@proforce.ca" },
  },
  privacy: {
...
function PrivacyPage({ lang, setPage }) {
  const t = {
    en: {
      ...
      sections: [
        { h:"Who We Are", p:"Proforce Personnel Inc. is a specialist recruitment firm headquartered in Montreal, Quebec, Canada. We operate across Montreal and Toronto, placing professionals in the food, CPG, and fashion industries. You can reach us at info@proforce.ca or by phone at (514) 905-0606." },
    ...
    fr: {
      ...
      sections: [
        { h:"Qui nous sommes", p:"Proforce Personnel Inc. est une firme de recrutement spécialisée dont le siège social est à Montréal, Québec, Canada. Nous opérons à Montréal et Toronto, en plaçant des professionnels dans les industries alimentaire, CPG et mode. Vous pouvez nous joindre à info@proforce.ca ou par téléphone au (514) 905-0606." },
...
function useSEO(page, lang, blogPostId) {
  useEffect(() => {
    ...
    addSchema("schema-org", {
      ...
      "description": "Specialist recruitment firm in food, CPG, and fashion. Montreal and Toronto. Since 2001.",
      "foundingDate": "2001",
      ...
      "address": [
        ...
        {
          "@type": "PostalAddress",
          "streetAddress": "130 King Street West, Suite 1800",
      ...
      "contactPoint": [
        ...
        { "@type": "ContactPoint", "telephone": "+1-647-367-1526", "contactType": "customer service", "areaServed": "CA-ON", "availableLanguage": ["English","French"] },
      ],
...
const MARKETS = {
  ...
  toronto: {
    en: {
      ...
      phone: "(647) 367-1526",
      addr: "130 King Street West, Suite 1800, Toronto, ON M5X 1E3",
    },
    fr: {
      ...
      phone: "(647) 367-1526",
      addr: "130 King Street West, Bureau 1800, Toronto, ON M5X 1E3",
    },
            ...
            {recruiters.map(m => (
              <div key={m.name} style={{ background:C.ink, padding:"1.75rem", borderTop:`3px solid ${C.orange}`, flex:"1 1 220px" }}>
                <div style={{ display:"flex", alignItems:"center", gap:"1rem", marginBottom:"1rem" }}>
                  <div style={{ width:"40px", height:"40px", background:C.orange, display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Clash Display',sans-serif", fontSize:"0.85rem", color:"#fff", fontWeight:700, flexShrink:0 }}>{m.init}</div>
                  <div>
